...
|---|---|---|---|
| [001-pre-market-briefing](./001-pre-market-briefing/v0.1.0-free/) | 台股盤前情報 AI 摘要 → Telegram 推播 | v0.1.0-free | [Personal Use](./001-pre-market-briefing/v0.1.0-free/LICENSE.txt) |
...
1. 進入 template 資料夾的 README（譬如上表的 `001-pre-market-briefing/v0.1.0-free/`）
